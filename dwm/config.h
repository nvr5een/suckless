...
static const char col_gray3[]       = "#767676";
...
static const Rule rules[] = {
        ...
        { "URxvt",         NULL,       NULL,       1 << 1,       0,             0,           -1 },
        { "XTerm",         NULL,       NULL,       1 << 1,       0,             0,           -1 },
        ...
        { "VirtualBox",    NULL,       NULL,       1 << 5,       0,             0,           -1 },
        { "Remmina",       NULL,       NULL,       1 << 6,       1,             1,           -1 },
};
...
static const char *dmenucmd[] = { "dmenu_bind", NULL };
...
/* static const char *scratchpadcmd[] = { "urxvt", "-name", scratchpadname, "-geometry", "120x34", NULL }; */
static const char *exitcmd[]       = { "killall", "bash", NULL };
